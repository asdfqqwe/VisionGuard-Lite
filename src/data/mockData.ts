...
export const putawayTasks: PutawayTask[] = [
  ...
  { taskNo: 'PUT-RT-001', materialName: 'BRACKET, SUPPORT', targetLocation: 'A-01-02', source: 'RTN-20240521-0085 退料复检通过', status: '待执行' },
];

// ─── Return Inbound Orders ───
export const returnInboundOrders: ReturnInboundOrder[] = [
  {
    returnNo: 'TL2025060300017',
    workshop: '冲压车间',
    reason: '加工尺寸超差',
    submitter: '王班长',
    createdAt: '2025-06-03 09:18',
    auditStatus: '待审核',
    stationStatus: '复检中',
    inboundStatus: '待入库',
    station: 'Station-03',
    ...
    items: [
      {
        id: 'RTI-001',
        materialName: 'BRACKET, SUPPORT',
        oldBarcode: 'A12345-01',
        newBarcode: 'A12345-01R',
        expectedQty: 25,
        actualQty: 25,
        unit: 'PCS',
        category: '关键零部件',
    ...
    checks: {
      barcode: '旧码 A12345-01 已作废，新码 A12345-01R 已绑定',
      label: '标签完整，可读，无破损',
      visualCount: '25/25 PCS 一致',
      ocr: 'Part Number、Description、Lot Number、Work Order 均匹配',
      storage: '回可用库存 A-01-02',
    },
    auditTimeline: [
      { role: '车间', action: '提交退料单', time: '09:18' },
      { role: 'Admin', action: 'Agent 已核对退料原因和数量', time: '09:22' },
      { role: 'Station', action: '已准备复检工位', time: '09:25' },
    ],
  },
  {
    returnNo: 'RT-002',
