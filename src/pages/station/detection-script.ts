...
export const detectionScript: ScriptedItem[] = [
  // ① 矿泉水 — 通过 -------------------------------------------------------
  {
    ...
    qty: '12 箱',
    category: '标准件',
    thumbUrl: '/images/station-queue/queue-mineral-water.jpg',
    cameraImageUrl: '/images/inspect-water-pass.jpg',
    outcome: 'pass',
    stepLines: [
      '接收图像数据流，分辨率 1920×1080 · 帧 ID #2024-031601',
      '执行视觉点数：识别到 12 件矿泉水箱，与采购单数量一致',
    ...
    agentSuggestion:
      'AI 检测全部通过，建议按标准流程移交上架环节，目标库位 A-03-05。',
  },
  ...
  // ② 前保险杠 — L2 标签轻微磨损 -----------------------------------------
  {
    ...
    qty: '8 件',
    category: '关键件',
    thumbUrl: '/images/station-queue/queue-bumper.jpg',
    cameraImageUrl: '/images/inspect-bumper-pass.jpg',
    outcome: 'l2',
    stepLines: [
      '接收图像数据流，分辨率 1920×1080 · 帧 ID #2024-031602',
      '执行视觉点数：识别到 8 件保险杠，外观完整',
      '标签 OCR 检测：第 3 件标签存在轻微磨损，置信度 84.7%',
      '关键字段 OCR 抽检：型号、批次识别成功，料号字段降级置信',
      '综合判定：触发 L2 警示，建议人工复核问题件',
    ],
    stepChips: [
  ...
  // ③ 5W-40 机油 — L2 OCR 模糊 -------------------------------------------
  {
    ...
    qty: '6 桶',
    category: '标准件',
    thumbUrl: '/images/station-queue/queue-engine-oil.jpg',
    cameraImageUrl: '/images/inspect-oil-blur.jpg',
    outcome: 'l2',
    stepLines: [
      '接收图像数据流，分辨率 1920×1080 · 帧 ID #2024-031603',
      '执行视觉点数：识别到 6 桶机油，桶身完整',
      '标签 OCR 检测：标签贴标合规，整体可读',
      '关键字段 OCR 抽检：标准号识别置信度 61.3%，低于阈值',
      '综合判定：图像不清晰，建议人工 OCR 复核',
    ],
    stepChips: [
  ...
  // ④ 动力电池组 — L1 多模态拦截 ------------------------------------------
  {
    ...
    qty: '2 件',
    category: '特殊库',
    thumbUrl: '/images/station-queue/queue-battery.jpg',
    cameraImageUrl: '/images/inspect-battery-multimodal.jpg',
    outcome: 'l1',
    stepLines: [
      '接收图像数据流，分辨率 1920×1080 · 帧 ID #2024-031604',
      '执行视觉点数：识别到 2 件电池模组，外观存在变色异常',
      '标签 OCR 检测：高压警示标签合规',
      '多模态交叉验证：重力台 +0.3kg / 红外 +12°C / VOC 超标',
      '⚠ 综合判定：触发 L1 强拦截，疑似危险品泄漏',
    ],
    stepChips: [
